...
export default function QuickSearch({ items = [], placeholder = 'Quick search...', className = '' }) {
  ...
  return (
    <div ref={boxRef} className={`relative hidden md:block w-56 ${className}`}>
      <div className="flex items-center gap-2 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm focus-within:ring-2 focus-within:ring-blue-500/40 focus-within:border-blue-300 dark:focus-within:border-blue-500/50 transition">
