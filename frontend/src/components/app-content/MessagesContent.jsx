...
export default function MessagesContent() {
  ...
  // Shared with workspace/dashboard/manager MessagesPage.jsx — same endpoints.
  ...
  return (
    <div className="h-[600px] bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden flex">
      {/* Conversations list */}
