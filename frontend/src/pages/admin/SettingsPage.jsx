  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Platform configuration</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
          <h3 className="font-bold text-gray-700 dark:text-gray-200 mb-4">Platform Info</h3>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
          <h3 className="font-bold text-gray-700 dark:text-gray-200 mb-4">Your Account</h3>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <span className="bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 text-xs px-2 py-0.5 rounded-full font-medium mt-1 inline-block">
                Super Admin
              </span>
            </div>
          </div>
        ...
        {/* Tech Stack */}
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6 md:col-span-2">
          <h3 className="font-bold text-gray-700 dark:text-gray-200 mb-4">Tech Stack</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={name} className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-slate-800/60 rounded-lg">
