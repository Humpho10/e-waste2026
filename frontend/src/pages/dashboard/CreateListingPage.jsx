  ...
  if (!isVerified) {
    return (
      <DashboardLayout>
        <div className="max-w-2xl mx-auto text-center py-16">
          <div className="text-5xl mb-4">📧</div>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">Verify your email first</h2>
          ...
          {step === 4 && (
            <div>
              ...
              <div className="mt-6 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/50 rounded-xl px-4 py-3 flex gap-3">
                <span className="text-blue-500 dark:text-blue-400 shrink-0">ℹ️</span>
