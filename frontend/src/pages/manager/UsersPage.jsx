            ...
            <tbody>
              {filtered.map(user => (
                <tr key={user.id} className="border-t border-gray-50 hover:bg-gray-50 transition">
                  ...
                  <td className="px-4 py-3 text-gray-500 text-xs">{user.location || '—'}</td>
                  <td className="px-4 py-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      {canDeactivate && user.is_active && (
                        <button
                          ...
                          disabled={actionLoading === user.id}
                          className="text-xs bg-red-50 text-red-500 hover:bg-red-100 border border-red-200 px-3 py-1.5 rounded-lg font-medium transition disabled:opacity-50"
                        >
